...
<head>
    ...
    <link rel="stylesheet" href="../assets/styles/pages/editprofile.css">
...
<body>
    ...
    <main>
        <section class="personal-informations">
            <form method="POST" action="../process/editprofile-process.php" enctype="multipart/form-data">
                <div class="input-file avatar">
                    <label for="avatar">
                        <?php
                ...
                <div>
                    <?php echo "<p>@".$loggedUser['username']."</p>" ?>
                </div>
    ...
    <script>
        const avatarFileInputEl = document.querySelector("#avatar");
        const avatarPreviewEl = document.querySelector(".input-file img");
        const avatarPreviewObjEl = document.querySelector(".input-file object");

        avatarFileInputEl.onchange = e => {
